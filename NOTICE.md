...
`eval-frontier_cs` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/frontier_cs`)
...
- `direct_url`: `https://github.com/FrontierCS/Frontier-CS/archive/{SHA}.tar.gz`
- `direct_url`: `https://raw.githubusercontent.com/MikeMirzayanov/testlib/{SHA}/testlib.h`
- `direct_url`: `https://julialang-s3.julialang.org/bin/linux/x64/1.11/julia-1.11.3-linux-x86_64.tar.gz`
- `huggingface`: `FrontierCS/Frontier-CS`
