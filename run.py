#!/usr/bin/env python3
"""Run ONE problem of frontier_cs through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/frontier_cs"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one frontier_cs problem via TrustedRouter")
